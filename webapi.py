...
def poeexamples():    
    ...
    text = "Here are " + str(number) + " example sentences in spoken vernacular Cantonese at a " + level + " level of difficulty, along with their English translations, in JSON format:"
