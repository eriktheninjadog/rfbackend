...
def poeexamples():    
    ...
    text = "Write " + str(number) + " example sentences in English at a " + level + " level of difficulty, along with their Cantonese translation, in a dictionary in JSON format without any other text. Include words from the following list: " + wordlists.get_sample_A1_wordlist(number)
