...
def poeexamples():    
    ...
    text = "Write " + str(number) + " example sentences in spoken English at a " + level + " level of difficulty, along a translation to vernaculary spoken Cantonese, in JSON format:"
