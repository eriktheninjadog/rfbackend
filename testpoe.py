...
p = ProtocolMessage(role="user",content="What is 5 + 8")

queries = [ p ]
p = QueryRequest(version="1.0",query=queries,type = "query",user_id="user",conversation_id="",message_id="<missing>")

asyncio.run(get_final_response(p,'Assistant',"BWWP0zUenxCRm_SAY_LgQKfuJmR2gyMI4lIzm91suNk"))